...
#if DEBUG
    apnsCertName = @"ssrj_dev";
#else
    apnsCertName = @"ssrj_pro";
#endif
    
//    [[EaseMob sharedInstance] registerSDKWithAppKey:@"mfdssrj2016#mfdssrj2016" apnsCertName:nil];
    [[EaseMob sharedInstance] registerSDKWithAppKey:@"1103161009115367#mfd2016ssrj" apnsCertName:apnsCertName otherConfig:@{kSDKConfigEnableConsoleLogger:@NO}];
    
//    [[EaseMob sharedInstance] registerSDKWithAppKey:@"1103161009115367#mfd2016ssrj"
//                                       apnsCertName:nil];
    // 登录成功后，自动去取好友列表
    // SDK获取结束后，会回调
...
//    [alert show];
    ...
    NSLog(@"推送注册失败 didFailToRegisterForRemoteNotificationsWithError");
}
