...
@interface RJGotoUpDateViewController ()<UIAlertViewDelegate>
@end

@implementation RJGotoUpDateViewController
...
- (void)viewDidLoad {
    ...
    UIImageView *imageV = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, self.view.height)];
