...
#define CurrentUrlString @"/b82/api/v5/brand/findthumb"

@interface RJBrandDetailThumbViewController ()<RJHomeNewSubjectAndCollectionCellDelegate,ThemeDetailVCDelegate,CollectionsViewControllerDelegate,RJHomeCollectionAndGoodCellDelegate,RJTapedUserViewDelegate>
...
@implementation RJBrandDetailThumbViewController
- (void)viewDidLoad{
    [super viewDidLoad];
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"RJHomeCollectionAndGoodCell" bundle:nil] forCellReuseIdentifier:@"RJHomeCollectionAndGoodCell5"];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"品牌的点赞界面"];
    [TalkingData trackPageBegin:@"品牌的点赞界面"];

}
- (void)viewWillDisappear:(BOOL)animated{
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"品牌的点赞界面"];
    [TalkingData trackPageEnd:@"品牌的点赞界面"];
                ...
                for (NSDictionary * dic in homeList) {
                    ...
                    switch (type.intValue) {
                        ...
                        case 1:{
                            ...
                            RJHomeTopicModel *model = [[RJHomeTopicModel alloc]initWithDictionary:dic[@"data"] error:&e];
                            if (model) {
                        ...
                        case 2:{
                            ...
                            RJHomeItemTypeTwoModel *model = [[RJHomeItemTypeTwoModel alloc]initWithDictionary:dic[@"data"] error:&e];
                            if (model) {
                                [weakSelf.dataArray addObject:model];
                            }
                        }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([model isKindOfClass:[RJHomeItemTypeTwoModel class]]) {
        ...
        RJHomeCollectionAndGoodCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RJHomeCollectionAndGoodCell5"];
    ...
    if ([model isKindOfClass:[RJHomeWebActivityModel class]]) {
        RJHomeActivityTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"RJHomeActivityTableViewCell5"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([model isKindOfClass:[RJHomeItemTypeTwoModel class]]){
        ...
        CGFloat hei = [tableView fd_heightForCellWithIdentifier:@"RJHomeCollectionAndGoodCell5" configuration:^(RJHomeCollectionAndGoodCell * cell) {
            cell.topViewHieghtConstraint.constant = 35;
