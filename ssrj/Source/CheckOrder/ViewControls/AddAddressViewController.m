...
@interface AddAddressViewController ()<UITextViewDelegate,UIGestureRecognizerDelegate,CCCityPickerViewDelegate>
@property (weak, nonatomic) IBOutlet UITextField *nameTextField;
@property (weak, nonatomic) IBOutlet UITextField *phoneTextField;
@property (weak, nonatomic) IBOutlet UITextField *zipTextField;
@property (weak, nonatomic) IBOutlet UILabel *cityLabel;
@property (weak, nonatomic) IBOutlet CCTextView *addressTextView;
...
- (void)viewDidLoad{
    ...
    [saveBtn setTitle:@"保存并返回" forState:0];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"创建地址页面"];
    [TalkingData trackPageBegin:@"创建地址页面"];
...
-(void)viewWillDisappear:(BOOL)animated{
    ...
    [MobClick endLogPageView:@"创建地址页面"];
    [TalkingData trackPageEnd:@"创建地址页面"];
...
- (void)saveButtonAction:(UIButton *)sender {
    ...
    if ([self checkInfo]) {
        ...
        requestInfo.getParams = [NSMutableDictionary dictionaryWithDictionary:@{@"areaId":areaId,
                                                                                @"consignee":nameStr,
                                                                                @"isDefault":number,
                                                                                @"address":addressStr,
                                                                                @"zipCode":zipStr,
            ...
            if ([responseObject objectForKey:@"state"]) {
                ...
                if (number.boolValue == 0 ) {
                    ...
                    if (weakSelf.delegate) {
                        [weakSelf.delegate reloadNetData];
