...
@interface ThemeDetailVC ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,CollectionsViewControllerDelegate,RJTapedUserViewDelegate>
