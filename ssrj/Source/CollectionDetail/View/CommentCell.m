...
- (void)setYyLabelLayoutModel:(YYLabelLayoutModel *)yyLabelLayoutModel{
    ...
    [self.authorLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo([self getFontHeight]);
    }];
...
- (YYLabel *)commentLabel{
    if (_commentLabel == nil) {
        _commentLabel = [[YYLabel alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH-10-34-10-15, 100)];
...
- (UIButton *)deleteButton{
    if (_deleteButton == nil) {
        ...
        _deleteButton.titleLabel.textAlignment = NSTextAlignmentLeft;
