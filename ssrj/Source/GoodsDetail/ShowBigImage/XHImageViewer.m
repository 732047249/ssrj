...
//            CGRect zoomRect = [self zoomRectForScale:newScale withCenter:[sender locationInView:self]];
...
//        }
    ...
    UIImageView *imgView = [self.imgViews objectAtIndex:self.pageIndex];
    [UIView animateWithDuration:0.3 animations:^{
        if (CGAffineTransformEqualToTransform(imgView.transform, CGAffineTransformIdentity)) {
