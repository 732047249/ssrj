...
@interface RJHomeItemTypeFourModel ()
@end

@implementation RJHomeItemTypeFourModel

//+(JSONKeyMapper *)keyMapper{
//    return [[JSONKeyMapper alloc] initWithDictionary:@{@"memberPO":@"member"}];
//
//}
- (void)upDateLayout{
...
@implementation RJHomeItemTypeFourShareModel


@end


@implementation RJHomeTypeFourMeneberModel

@end


@implementation RJHomeTypeFourCollectionModel
