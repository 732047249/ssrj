...
- (void)drawTitle
{
    if (!_topTitle)
    {
        ...
        [backBtn setImage:[UIImage imageNamed:@"scan_back_nor"] forState:UIControlStateNormal];
        [backBtn setImage:[UIImage imageNamed:@"scan_back_pressed"] forState:UIControlStateSelected];
        ...
        [backBtn bringSubviewToFront:backBtn];
...
{
//    UIAlertView *alrt = [[UIAlertView alloc] initWithTitle:@"提示" message:str delegate:self cancelButtonTitle:@"取消" otherButtonTitles:nil];
//    
//    [alrt show];
...
- (void)popAlertMsgWithScanResult:(NSString*)strResult
{
    ...
    UIAlertView *alrt = [[UIAlertView alloc] initWithTitle:@"扫码内容" message:strResult delegate:weakSelf cancelButtonTitle:nil otherButtonTitles:@"知道了", nil];
