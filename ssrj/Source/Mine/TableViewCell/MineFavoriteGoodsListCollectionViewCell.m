//
//  MineFavoriteGoodsListCollectionViewCell.m
//  ssrj
//
...
@interface MineFavoriteGoodsListCollectionViewCell ()<UIScrollViewDelegate>

@end


@implementation MineFavoriteGoodsListCollectionViewCell
...
//            使用模型变出错，还是对二级模型赋值理解不深，不太会用
//            MineSingleGoodsImageListModel *imageModel = [[MineSingleGoodsImageListModel alloc] initWithDictionary:[model.imgsList  objectAtIndex:i] error:nil];
