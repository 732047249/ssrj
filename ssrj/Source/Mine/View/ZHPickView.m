...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, 0,SCREEN_WIDTH, ZHToobarHeight);
}
...
//    NSMutableAttributedString *attrString = [[NSMutableAttributedString alloc] initWithString:_plistArray];
