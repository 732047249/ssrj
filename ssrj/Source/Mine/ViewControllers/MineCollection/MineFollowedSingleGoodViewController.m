//
//  MineFollowedSingleGoodViewController.m
//  ssrj
//
...
#import "MineBoughtGoodsModel.h"//赞过单品cell的Model适用
#import "MineFavoriteGoodsListCollectionViewCell.h"
#import "GoodsDetailViewController.h"
#import "ZanModel.h"

@interface MineFollowedSingleGoodViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, MineFavoriteGoodsListCollectionViewCellDelegate>
...
@implementation MineFollowedSingleGoodViewController

- (void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];

    [MobClick beginLogPageView:@"我的收藏－收藏单品页面"];
    [TalkingData trackPageBegin:@"我的收藏－收藏单品页面"];

}
- (void)viewWillDisappear:(BOOL)animated{
    [super viewWillDisappear:animated];

    [MobClick endLogPageView:@"我的收藏－收藏单品页面"];
    [TalkingData trackPageEnd:@"我的收藏－收藏单品页面"];
...
- (void)getNetData {
    ...
    requestInfo.URLString = [NSString stringWithFormat:@"/b82/api/v5/find-thumb-list?pageIndex=%d&pageSize=10&type=goods",_pageNumber];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    MineFavoriteGoodsListCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"MineFavoriteGoodsListCollectionViewCell" forIndexPath:indexPath];
    [cell hideRightLine];
...
//    statisticalDataModel.entranceType = [NSNumber numberWithInt:1031];
